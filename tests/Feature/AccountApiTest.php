...
class AccountApiTest extends AbstractTestCase
{
    ...
    protected function makePhysicalPersonAccountDTO(): AccountDTO
    {
        ...
        return (new AccountDTO())
            ...
            ->setBirthDate(Zapsign::dateToString(1990, 12, 12))
            ->setAddress(
                (new Address())
    ...
    protected function makeLegalPersonAccount(): AccountDTO
    {
        ...
        $cnpj = '03627536000120';
        $cpf = '33657214607';
        $birthDate = Zapsign::dateToString(1953, 03, 01);
        ...
        return (new AccountDTO())
            ...
            ->setCnae('8599603')
            ->setEstablishmentDate(Zapsign::dateToString(2021, 01, 01))
